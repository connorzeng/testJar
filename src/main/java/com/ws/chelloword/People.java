...
public class People {
    ...
    @XmlElementRef(name = "name", namespace = "http://helloworld.ws.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> name;
    @XmlElementRef(name = "nickName", namespace = "http://helloworld.ws.com", type = JAXBElement.class, required = false)
