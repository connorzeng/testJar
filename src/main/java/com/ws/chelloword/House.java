...
public class House {
    ...
    @XmlElementRef(name = "address", namespace = "http://helloworld.ws.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> address;
    @XmlElementRef(name = "houseNo", namespace = "http://helloworld.ws.com", type = JAXBElement.class, required = false)
